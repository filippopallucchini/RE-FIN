...
def main():
    ...
    output.to_csv(f'{path}/OUTPUT/output_financial_db_decoder_only_delta_allagree.csv')
    ...
    output_sentences.to_csv(f'{path}/OUTPUT/check_sentences_enriched_for_decoder_only_delta_evaluator_allagree.csv')
