...
def main():
    ...
    for document in tqdm(dataset['train']):
        original_document = document['clean_content']
        name_of_document = document['title']
    ...
    output_sentences_enriched.to_csv(f'{path}/DATA_SHARED/check_subsentences_densex_investopedia_2.csv')

    # create a binary pickle file 
    f = open(f"{path}/DATA_SHARED/file_subsentences_densex_investopedia_2.pkl","wb")
    ...
    # create a binary pickle file 
    f = open(f"{path}/DATA_SHARED/file_doc_to_subsentences_densex_investopedia_2.pkl","wb")
