...
def main():
    ...
    for file in os.listdir(directory):
        ...
        if f'file_{num_candidates}_candidates_for_enrichment_sentfin_ablation_no_retrieval.pkl' == filename:
    ...
    if check_presence_candidates == False:
        ...
        f = open(f"{path}/DATA/file_{num_candidates}_candidates_for_enrichment_sentfin_ablation_no_retrieval.pkl","wb")
        # write the python object (dict) to pickle file
        pickle.dump(list_input_and_sentences_candidates,f)
        # close file
        f.close()
    else:
        list_input_and_sentences_candidates = pickle.load(open(f"{path}/DATA/file_{num_candidates}_candidates_for_enrichment_sentfin_ablation_no_retrieval.pkl", 'rb'))
    ...
    output_sentfin_enriched.to_csv(f'{path}/OUTPUT/sentfin_enriched_ablation_no_retrieval.csv')
