...
def main():
    ...
    output.to_csv(f'{path}/OUTPUT/output_financial_db_decoder_only_tot_sentfin.csv')
    ...
    output_sentences.to_csv(f'{path}/OUTPUT/check_sentences_enriched_for_decoder_only_tot_evaluator_sentfin.csv')
